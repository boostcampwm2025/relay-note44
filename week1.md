...
> AI를 "작업 보조"가 아닌 "학습 파트너"로서 단순히 정답을 묻는 게 아니라 내가 짠 계획을 검토받고 빈틈을 메워가는 식의 상호작용이 인상 깊었습니다. 특히 이해가 부족한 개념은 AI에게 설명을 유도하고, 그 과정에서 생긴 의문을 다시 질문하며 학습 깊이를 넓힐 수 있었습니다. 
> 처음에는 로드맵 작성이 막막했지만 AI와 함께 순서를 정리하고 필요 지식을 묶어가며 점차 전체 구조를 잡을 수 있었습니다. 체크포인트나 문서 흐름도 피드백을 받아가며 개선했고, 그 결과 나만의 정리 방식이 생겼다는 점에서 의미 있었습니다.
> 이번 경험을 통해 AI는 실행 도구를 넘어 사고의 흐름을 함께 정리해주는 동료처럼 느껴졌습니다.
---
